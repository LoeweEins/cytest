# Introduction
This is a automation test framework written by Zeen for the first time, where I merged the mature and mainly used framework 'pytest' and an experimental framework 'hytest'. The two automation framework almost built my entire carrier as a software testing engineer. 
